            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav ms-auto">
                    ...
                    <li class="nav-item ms-2">
                        <a href="{{ route('public.sample-request') }}" class="btn btn-primary btn-cta">
            ...
            <div class="row align-items-center">
                <div class="col-lg-6">
                    ...
                    <div class="d-flex flex-wrap gap-3">
                        <a href="{{ route('public.sample-request') }}" class="btn btn-light btn-cta btn-lg">
                ...
                <div class="col-md-8 text-center">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <a href="{{ route('public.sample-request') }}" class="btn btn-primary btn-cta me-3">
                                <i class="fas fa-vial me-2"></i>Ajukan Pengujian
                            </a>
