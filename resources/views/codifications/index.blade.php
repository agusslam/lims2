            ...
            <div class="card-body">
                <div class="d-flex justify-content-between">
                    <div>
                        ...
                        <h3 class="mb-0">
                            {{ \App\Models\Sample::where('status', 'codified')->whereDate('updated_at', today())->count() }}
                        </h3>
                    </div>
                    <div class="align-self-center">
            ...
            <div class="card-body">
                <div class="d-flex justify-content-between">
                    <div>
                        ...
                        <h3 class="mb-0">
                            {{ \App\Models\Sample::where('status', 'pending')->whereDate('updated_at', today())->count() }}
                        </h3>
                    </div>
                    <div class="align-self-center">
...
<div class="card">
   ...
   ?? '— Tidak ada data pelanggan —' }}
                            ...
                            <div class="col-md-6">
                                <p class="mb-1">
                                    <strong>Jenis Sampel:</strong>
                                    {{ $sample->sampleType->name ?? $sample->custom_sample_type }}
                                </p>
                                <p class="mb-1">
                        ...
                        <div class="mb-3">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6 mb-2">
                                    <strong>{{ $category ?? 'Lainnya' }}:</strong>
                                    <ul class="mb-0 ms-3">
                                        @foreach($parameters as $parameter)
                                        <li>{{ $parameter->name }} ({{ $parameter->unit }})</li>
                                        @endforeach
                                    </ul>
                                </div>
                                @endforeach
                    ...
                    <div class="col-md-4">
                        <form action="{{ route('samples.codify', $sample->id) }}" method="POST">
                            ...
                            <div class="mb-3">
                                ...
                                <textarea class="form-control" name="codification_notes" rows="3"
                            ...
                            <div class="mb-3">
                                <div class="form-check">
                                    <input class="form-check-input" type="radio" name="action" value="approve"
                                        id="approve_{{ $sample->id }}" required>
